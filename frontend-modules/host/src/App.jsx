...
const ProtectedRoute = lazy(() => import('auth-microfrontend/ProtectedRoute').catch(() => {
        return { default: () => <div className='error'>Component is not available!</div> };
    })
);
...
const AddPlacePopup = lazy(() => import('photos-microfrontend/AddPlacePopup').catch(() => {
        return { default: () => <div className='error'>Component is not available!</div> };
    })
);
const Card = lazy(() => import('photos-microfrontend/Card').catch(() => {
        return { default: () => <div className='error'>Component is not available!</div> };
    })
);
...
import AddPlacePopup from "./photos/AddPlacePopup";
